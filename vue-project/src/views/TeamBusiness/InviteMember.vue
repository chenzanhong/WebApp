    ...
    <div class="form-section">
      <el-form :model="joinForm" :rules="joinRules" ref="joinFormRef" label-position="left" label-width="225px">
        ...
        <el-form-item label="成员姓名" prop="realName">
          <el-col :span="18">
            <el-input v-model="joinForm.realName" placeholder="请输入成员姓名" class="dark-input" />
          </el-col>
        </el-form-item>

        <el-form-item label="成员用户名" prop="memberName">
          <el-col :span="18">
            <el-input v-model="joinForm.memberName" placeholder="请输入成员用户名" class="dark-input" />
          </el-col>
        </el-form-item>
        <el-form-item label="成员邮箱" prop="memberEmail">
          <el-col :span="18">
            <el-input v-model="joinForm.memberEmail" placeholder="请输入成员邮箱" class="dark-input" />
          </el-col>
        </el-form-item>
    ...
    <div class="notice-section">
      <div class="notice-box">
        ...
        <div class="notice-content">
          <div>请注意在主页面侧边栏“通知”处查收成员方确认邀请的结果。
